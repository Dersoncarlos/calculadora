...
$(document).ready(function () {
  ...
  $('.number').click(function () {
    ...
    if ($("#operador").text().length > 0) {
      if (entrada.hasClass("operador")) {// console.log($("#dadosCalculo").text().substr($("#operador").text().length - 1));
  ...
  $('#calcular').click(function () {
    var result = window.axios({
      method: 'post',
      url: '/',
      data: {
        data: $("#dadosCalculo").text().trim()
      }
    });
...
__webpack_require__(/*! /Applications/Projetos/sites/calculadora/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /Applications/Projetos/sites/calculadora/resources/sass/app.scss */"./resources/sass/app.scss");
